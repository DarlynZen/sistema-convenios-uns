<article class="group w-full max-w-[360px] overflow-hidden rounded border border-neutral-400 bg-neutral-100 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
	<a href="{{ $href ?? '#' }}" class="block">
		...
		<div class="space-y-3 px-5 py-4">
			<div class="space-y-2">
				<h3 class="text-base font-extrabold leading-6 text-neutral-800 group-hover:text-[#D9324D]">
					{{ $title ?? '' }}
				</h3>
			...
			<div class="pt-1">
				<div class="h-px w-full bg-gradient-to-r from-neutral-300 via-neutral-300/60 to-transparent"></div>
			</div>

			<div class="flex items-center justify-between pt-1">
				<span class="text-sm font-bold text-[#D9324D]">Leer más</span>
				<span class="inline-flex h-9 w-9 items-center justify-center rounded-full bg-white ring-1 ring-neutral-200 transition group-hover:bg-brand-25 group-hover:ring-[#D9324D]/30">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="h-4 w-4 text-[#D9324D]">
