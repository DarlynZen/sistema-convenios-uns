<aside id="sidebar" class="w-56 py-10 h-full bg-neutral-25 z-40 transform transition-transform duration-300 flex-shrink-0 overflow-y-auto -translate-x-full absolute left-0 top-0 lg:translate-x-0 lg:relative">
    <!-- <ul class="mb-4">
        <li>
