        ...
        <x-slot name="footer">
            <div x-data="{ step: 1, maxStep: 3 }" x-on:step-changed.window="step = $event.detail.step" class="flex flex-row items-center gap-2">
                <x-admin.cancel-button
                    @click="$dispatch('close-modal', 'crearConvenio')"
                ...
                <x-admin.confirm-button
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" class="h-4 w-4" aria-hidden="true">
                        <path fill="currentColor" d="M221.66,133.66l-72,72a8,8,0,0,1-11.32-11.32L196.69,136H40a8,8,0,0,1,0-16H196.69L138.34,61.66a8,8,0,0,1,11.32-11.32l72,72A8,8,0,0,1,221.66,133.66Z"></path>
                    </svg>
                </x-admin.confirm-button>
